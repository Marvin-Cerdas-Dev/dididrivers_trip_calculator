...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Este sitio muestra los contactos de ayuda para conductores en caso de emergencia, mientras utiliza la plataforma Didi, Además podrás encontrar la línea de ayuda para conductores México, así una sección de preguntas frecuentes.">
                            ...
                            <div class="accordion" id="accordionQuestions">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            ...
                                            <ul>
                                                <li>Certificado de no antecedentes penales federales. (El mismo de no pude tener 
                                                    más de 3 meses de haber sido expedido)</li>
                                            ...
                                            <p class="justify-text">Es importante mencionar que esta información puede cambiar en 
                                                conformidad con las legislaciones locales. Contacta a soporte Didi, para confirmar 
                                                los requerimientos en tu ciudad.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                           ¿Puedo agregar un vehículo un conductor si no soy socio no conductor?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Únicamente los socios no conductores podrán agregar vehículos 
                                                conductores a sus flotas. Sin embargo, puedes referir a otros conductores para que 
                                                manejen en la aplicación con tu código y recibas beneficios. Si eres Conductor y 
                                                deseas convertirte en Socio No Conductor, lo puedes solicitar directamente con 
                                                soporte Didi, llamando al 
                                                <a href="tel: 800-725-8888" class="btn btn-update" hreflang="es"><b>800-725-8888</b></a> 
                                                o puedes acudir al Club de Conductores más cercano a tu ubicación, cuya dirección podrás 
                                                ver en la app.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Las características de los vehículos que acepta actualmente en Didi, 
                                                son:</p>
                                            <ul>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">En Didi alentamos que conductores con diferentes habilidades puedan 
                                                conducir, siempre que dicha discapacidad no limite el manejo seguro. Si tienes dudas 
                                                puntuales, puedes contactar al soporte DiDi al 
                                                <a href="tel: 800-725-8888" class="btn btn-update" hreflang="es"><b>800-725-8888</b></a></p>
                                        </div>
                                    </div>
                                </div>                            
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Pueden existir diversas razones por las cuales estés teniendo problemas 
                                                con el registro, para poder brindarte una mejor solución, por favor contacta a Soporte Didi 
                                                al <a href="tel: 800-725-8888" class="btn btn-update" hreflang="es"><b>800-725-8888</b></a> 
                                                o informarnos en el campo de abajo e indícanos el tipo de problema que estás presentando.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Presiona en “Carreras” y selecciona la carrera en la que tuviste el problema, 
                                                luego ve a “Detalles de la carrera” y “Ayuda” y “problemas con la carrera” y selecciona la opción 
                                                más cercana al problema que ocurrió.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Una vez que tengas una alerta de servicio, en la parte inferior de la 
                                                pantalla verás la opción de “aceptar”, recuerda, tienes 15 segundos para aceptar haciendo 
                                                clic en el botón correspondiente.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Una vez aceptado el viaje, podrás ver en tu pantalla el nombre de tu 
                                                pasajero. Podrás comunicarte con él para acordar un punto de encuentro y/o para preguntarle 
                                                sobre algún factor para facilitar su identificación. Por tu seguridad, siempre confirma que 
                                                el pasajero que está subiendo a tu automóvil corresponda al usuario que aparece en la app. 
                                                En caso que no sea así, por favor contacta al usuario para confirmar la situación. Asuntos 
                                                relacionados: Quiero comunicarme con mi pasajero.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Para consultar tu historial de viajes: haz clic en “Mi billetera” y 
                                                selecciona “Historial de viajes”, se desplegará la lista de todos los viajes que has 
                                                realizado.</p>
                                        </div>
                                    </div>
                                </div>    
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Puedes hacer clic en “Carreras” y selecciona la carrera que tuvo el 
                                                problema, luego ve a “Detalles de la carrera” y “Ayuda” y “problemas con la carrera” y 
                                                selecciona la opción correspondiente al problema que ocurrió, por favor bríndanos la 
                                                mayor cantidad de información posible sobre lo que pasó.</p>
                                        </div>
                                    </div>
                                </div>                                  
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionQuestions" >
                                        <div class="accordion-body">
                                            <p class="justify-text">Puedes ingresar a la sección “Detalles de viaje” en la parte superior 
                                                derecha de la pantalla, haz clic en “Servicios de emergencia” y luego seleccionar a 
                                                “Contactos de emergencia”, ahí podrás incluir o editar la información de tus contactos de 
                                                emergencia.</p>
                                        </div>
                                    </div>
                                </div>
