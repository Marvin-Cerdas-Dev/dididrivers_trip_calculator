<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12"> 
            <a id="facebook" href="http://www.facebook.com/sharer.php?u=https://crdidicalc.azurewebsites.net/" target="_blank" alt="Compartir en Facebook" title="Facebook" hreflang="es">
                <img class="socialmedia-img"  src="img/facebook.png" alt="Compartir en Facebook"/>
            </a>
            <a id="whatsapp" href="https://wa.me/?text=Didical%20la%20calculadora%20para%20los%20socios%20conductores%20https://crdidicalc.azurewebsites.net/" target="_blank" alt="Compartir en Whatsapp" title="Compartir en Whatsapp" hreflang="es">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">DidiCalc Services 2022 &COPY;
        ...
        <div id="dropdown-countries" class="btn-group dropup">
            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#coutryModal">Seleción de País</button>
        </div>  
        <div class="col-xs-12 col-md-12 col-lg-12">Version 2.0.2</div>
    </div>

    <!-- Information Modal -->
    <div class="modal fade modalCountry" id="coutryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
